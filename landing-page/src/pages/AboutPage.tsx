          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-4">
                AgriVet was founded in 2014 with a simple mission: to provide quality agricultural 
              ...
              <p className="text-lg text-gray-600 mb-4">
                Our founder, Maria Santos, grew up in a farming family and understood the challenges 
